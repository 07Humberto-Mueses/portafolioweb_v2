export const proyectoApis = [
    {
        ...
        "funcionamiento": "En un panel de búsqueda, el usuario puede ingresar términos para buscar GIFs relacionados y ver los resultados en una cuadrícula dinámica.",
        "tecnologias": [
            "Tailwind CSS",
            "JavaScript",
            "React",
    ...
    },
    {
        ...
        "funcionamiento": "La aplicación cuenta con un dashboard de presentacion y tres modulos nombrados como Marvel, DC y Anime que son indicativos de los tipos de heroes que se pueden buscar y visualizar en la aplicación. En cada modulo se presenta un panel de busqueda para el usuario.",
        "tecnologias": [
            "Tailwind CSS",
            "JavaScript",
            "React",
    ...
    },
    {
        ...
        "funcionamiento": "En la pagina principal se muestran tarjetas de animes populares y continua cargando mas animes cuando sigue bajando la pagina.",
        "tecnologias": [
            "Tailwind CSS",
            "TypeScript",
            "React",
    ...
    },
    {
        ...
        "funcionamiento": "En la pagina principal se encuentra una barra de busqueda para ingresar la palabra clave de la pelicula y que se muestre una tarjeta con la informacion de la busqueda y se reinicie con cada nueva busqueda.",
        "tecnologias": [
            "Tailwind CSS",
            "TypeScript",
            "React",
